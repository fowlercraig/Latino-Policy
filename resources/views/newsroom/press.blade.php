  ...
  <section id="press-release" class="bg-brand-dark">
    <div class="sm:grid grid-cols-5 items-center">
      ...
      <div class="col-span-2 space-y-4 p-8">
        <h2 class="text-2xl sm:text-3xl xl:text-5xl leading-9 font-extrabold tracking-tight text-white sm:text-4xl sm:leading-10 xl:leading-13">@php the_field('press_title') @endphp</h2>
