<div class="relative overflow-hidden pt-20">
  <div class="py-20 bg-brand-lightest overflow-hidden relative">
    ...
    <div class="opacity-25 absolute top-0 left-0 pointer-events-none z-0">
      <img 
        alt="Pattern" 
        class="opacity-75" src="@asset('images/Pattern.png')" srcset="@asset('images/Pattern.png') 1x, @asset('images/Pattern@2x.png') 2x, @asset('images/Pattern@3x.png') 3x">
    </div>
    <div class="absolute top-0 right-0 pointer-events-none z-0">
      <img 
        alt="Donate" 
        class="" src="@asset('images/donate.svg')">
    </div>
  </div>
</div>