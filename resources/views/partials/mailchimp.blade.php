<style>
  ...
  * html #mc_embed_signup .size1of2 {margin-right:2%; /* Fix for IE6 double margins. */}
  ...
  #mc_embed_signup #mc-embedded-subscribe-form div.mce_inline_error {display:inline-block; margin:2px 0 0 0; padding:5px 10px; background-color:rgba(255,255,255,0.85); -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; font-size:14px; font-weight:normal; z-index:1; color:#e85c41;}
...
<form 
  style="padding:0" 
  action="https://ucla.us16.list-manage.com/subscribe/post?u=d021c35e6a05ad46f78ac6f1d&amp;id=1d321a06c6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
