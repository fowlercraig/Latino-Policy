    ...
    <div class="grid lg:grid-cols-5 gap-8">
      <div class="col-span-2 xl:border-r border-gray-100">
        <div class="space-y-4">
          ...
          <p class="font-display uppercase text-2xl sm:text-3xl text-gray-900 leading-6 sm:leading-8">There is No American Agenda <br>Without a Latino Agenda</p>
          <div class="flex space-x-4 items-center">
            @php $url = get_field('facebook','option') @endphp
            <a target="_blank" href="@php echo $url['url'] @endphp" class="text-brand hover:text-gray-500">
            ...
            @php $url = get_field('youtube','option') @endphp
            <a target="_blank" href="@php echo $url['url'] @endphp" class="text-brand hover:text-gray-500">
            ...
            @php $url = get_field('linkedin','option') @endphp
            <a target="_blank" href="@php echo $url['url'] @endphp" class="text-brand hover:text-gray-500">
