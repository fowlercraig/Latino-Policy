<!-- People menu -->
<div 
  x-description="'People' flyout menu, show/hide based on flyout menu state." 
  x-show="peopleMenuOpen" 
...
>
  <div class="bg-white">
    <div class="max-w-7xl mx-auto px-4 py-6 pb-0">
      <a href="/people" class="text-4xl font-bold font-extrabold text-brand-darker border-b-4 border-brand-lighter">People</a>
    </div>
