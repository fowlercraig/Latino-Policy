...
>
  <div class="bg-white">
    <div class="max-w-7xl mx-auto px-4 py-6 pb-0">
      <a href="/issues" class="text-4xl font-bold font-extrabold text-brand-darker border-b-4 border-brand-lighter">Issues</a>
    </div>
    <div class="max-w-7xl mx-auto grid row-gap-6 px-4 py-6 sm:grid-cols-2 sm:gap-8 sm:px-6 sm:pb-8 lg:grid-cols-5 lg:px-4 lg:pb-12 xl:pb-16">
        ...
        <div class="space-x-4 flex md:h-full lg:flex-col lg:space-x-0 lg:space-y-4">
          <div class="flex-shrink-0">
            <div class="w-32 lg:w-full rounded relative">
              ...
              <div class="aspect-ratio aspect-ratio--1x1 lg:aspect-ratio--4x3 bg-brand-darker rounded"></div>
            </div>
          </div>
