      ...
      @if ($navigation)
        @foreach ($navigation as $item)
          <li class="group" @mouseenter="menu=true " @mouseleave="menu = null">
            ...
            @if ($item->children)
              <div class="bg-white p-6 absolute top-full text-black inset-x-0 hidden invisible opacity-0 transition ease duration-500 group-hover:block group-hover:visible group-hover:opacity-100">
