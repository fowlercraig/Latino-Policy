...
<header 
  ...
  x-data="{open:true}" 
  class="banner inset-x-0 z-40 @if(is_front_page()) absolute @endif flex items-center sm:block">
        ...
        <div class="hidden flex-1 sm:flex items-center justify-center px-2 lg:ml-6 lg:justify-end">
          <div class="max-w-lg w-full lg:max-w-xs">
            ...
            <div class="relative">
              ...
              <input id="search" class="block w-full pl-8 pr-3 py-2 text-white border-b border-gray-300 rounded-none leading-5 bg-transparent placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-blue-300 focus:shadow-outline-transparent sm:text-sm transition duration-150 ease-in-out" placeholder="Search" type="search">
            </div>
          </div>
        </div>
