...
<div 
  ...
  x-data="{ mobileMenuOpen: false, workMenuOpen: false, issuesMenuOpen: false, vrpMenuOpen: false, peopleMenuOpen: false, donateMenuOpen: false }" class="z-40 relative bg-white sticky">
  ...
  <div class="container py-4 border-t border-gray-100 hidden lg:flex justify-between items-center">
    <nav class="flex space-x-3 xl:space-x-6 font-brand uppercase tracking-wider">
      <a 
        @php $link = 658; @endphp
        href="@php echo get_the_permalink($link) @endphp" 
        class="leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
        @php echo get_the_title($link); @endphp
      </a>
      <div class="relative">
        <button 
          ...
          x-state:on="Item active" x-state:off="Item inactive" :class="{ 'text-gray-900': workMenuOpen, 'text-gray-500': !workMenuOpen }" class="group inline-flex items-center space-x-2 leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150 text-gray-500">
      ...
      <div class="relative">
        <button 
          ...
          x-state:on="Item active" x-state:off="Item inactive" :class="{ 'text-gray-900': issuesMenuOpen, 'text-gray-500': !issuesMenuOpen }" class="text-gray-500 group inline-flex items-center space-x-2 leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
      ...
      <div class="relative">
        <button 
          ...
          x-state:on="Item active" x-state:off="Item inactive" :class="{ 'text-gray-900': vrpMenuOpen, 'text-gray-500': !vrpMenuOpen }" class="text-gray-500 group inline-flex items-center space-x-2 leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
      ...
      <div class="relative">
        <button 
          ...
          x-state:on="Item active" x-state:off="Item inactive" :class="{ 'text-gray-900': peopleMenuOpen, 'text-gray-500': !peopleMenuOpen }" class="text-gray-500 group inline-flex items-center space-x-2 leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
      ...
      <a 
        @php $link = 656; @endphp
        href="@php echo get_the_permalink($link) @endphp" 
        class="hidden xl:block leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
        @php echo get_the_title($link); @endphp
      </a>
    </nav>
    <nav class="flex space-x-3 justify-between md:justify-end items-center">
      ...
      <a href="<?php echo $url['url']; ?>" title="Opens Instagram in a new window" class="ml-6 text-gray-500 hover:text-gray-300 hidden md:block">
      ...
      <a href="<?php echo $url['url']; ?>" title="Opens Twitter in a new window" class="ml-6 text-gray-500 hover:text-gray-300 hidden md:block">
