<header 
  ...
  <div class="container hidden md:block relative">
    ...
    <div class="absolute inset-x-0">
      <div class="bg-white shadow-xl">
        <div class="container">
          {{-- @include('components.menu-content',['id'=>  6, 'title'=>'Work'])
          @include('components.menu-content',['id'=>  8, 'title'=>'Issues'])
          @include('components.menu-content',['id'=> 10, 'title'=>'Voting Rights Project'])
