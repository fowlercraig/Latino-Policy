<div class="">
  <div class="container bg-white max-w-none">
    <nav class="flex space-x-3 py-2 justify-between md:justify-end items-center">
      ...
      <a href="<?php the_field('instagram','option'); ?>" title="Opens Instagram in a new window" class="ml-6 text-gray-500 hover:text-gray-300 hidden md:block">
      ...
      <a href="<?php the_field('twitter','option'); ?>" title="Opens Twitter in a new window" class="ml-6 text-gray-500 hover:text-gray-300 hidden md:block">
