...
<div 
  ...
  <div class="container h-16 @php echo $borderWidth; @endphp @php echo $borderColor; @endphp hidden md:flex justify-between items-center">
    ...
    <nav class="flex space-x-3 justify-between md:justify-end items-center">
      ...
      <a target="_blank" href="<?php echo $url['url']; ?>" title="Opens Facebook in a new window" class="@php echo $textColor @endphp hover:text-gray-300 hidden md:block">
      ...
      <a target="_blank" href="<?php echo $url['url']; ?>" title="Opens Instagram in a new window" class="ml-6 @php echo $textColor @endphp hover:text-gray-300 hidden md:block">
      ...
      <a target="_blank" href="<?php echo $url['url']; ?>" title="Opens Twitter in a new window" class="ml-6 @php echo $textColor @endphp hover:text-gray-300 hidden md:block">
