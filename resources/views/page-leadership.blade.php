...
@section('content')
  @while(have_posts()) @php the_post() @endphp
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
      <div class="border-t border-gray-100 py-10 flex flex-wrap">
        <div class="lg:w-1/3">
        ...
        <div class="lg:w-2/3">
          <p class="mb-0 text-gray-500"><?php the_field('overview_desc'); ?></p>
        </div>
      </div>
    </div>
    <!-- Overview -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
      <div class="border-t border-gray-100 py-10 flex flex-wrap">
        ...
        <div class="lg:w-2/3">
          <p class="mb-0 text-gray-500"><?php the_field('program_desc'); ?></p>
        </div>
      </div>
    </div>
    <!-- Overview -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
      <div class="border-t border-gray-100 py-10 flex flex-wrap">
        ...
        <div class="lg:w-2/3">
          <p class="mb-0 text-gray-500"><?php the_field('process_desc'); ?></p>
        </div>
      </div>
    </div>
    <!-- FAQ -->
        ...
        <div class="lg:w-2/3">
          <div  x-data="{ openPanel: 1 }">
            ...
            <div class="border-b border-gray-100 mb-3">
              ...
              <p class="mb-0 text-gray-500 py-3"><?php echo $item['answer']; ?></p>
            </div>
            <?php endforeach; ?>
          </div>
        </div>
