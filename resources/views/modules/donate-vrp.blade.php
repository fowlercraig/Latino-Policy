      ...
      <div class="w-full col-span-5 lg:col-span-2">
          ...
          <div class="w-full">
            <div class="aspect-ratio aspect-ratio--16x9 relative">
              <a  
                ...
                href="https://giving.ucla.edu/campaign/?amount=@php echo $amount @endphp&OrgType=S&OrgNum=1320&fund=64616o"
        ...
        <div class="lg:text-right">
          <a
            ...
            class="bg-brand-darker rounded px-5 py-3 text-white leading-none text-white font-medium">Make a Donation</a>
        </div>
      </div>
    </div>
  </div>
