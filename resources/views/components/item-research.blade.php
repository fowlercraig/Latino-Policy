<article class="overflow-hidden text-white" data-aos="fade-up">
  <div class="aspect-w-16 md:aspect-w-21 aspect-h-9 lg:aspect-w-4 lg:aspect-h-3 bg-black relative">
    ...
    <div class="absolute inset-0 flex flex-col px-4 md:px-6 xl:px-10">
      ...
      <div class="mt-4">
        <h2 class="tracking-tight font-bold text-3xl xl:text-4xl leading-7 xl:leading-none font-primary-a uppercase">@title</h2>
      </div>
