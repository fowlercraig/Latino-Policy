<div class="relative bg-black text-white">
  <div class="aspect-w-1 aspect-h-1 md:aspect-w-4 md:aspect-h-3 lg:aspect-h-9 lg:aspect-w-16 2xl:aspect-w-21 relative">
    ...
    <div class="absolute inset-0 flex items-end md:items-center">
      <div class="container">
        ...
        <div class="md:w-2/3 space-y-4 pb-8 md:pb-0">
          ...
          <h1 class="tracking-tight font-bold text-5xl xl:text-6xl 2xl:text-7xl font-primary-a uppercase">
            @title
          </h1>
