  ...
  <section class="relative bg-black">
    ...
    <div class="absolute inset-x-0 bottom-0">
      <div class="container flex outline-none" id="carousel-controls">
        @set($classes,'h-12 w-12 md:h-10 md:w-10 flex items-center justify-center text-white bg-brand hover:bg-brand-dark transition transition ease-in-out duration-150 hover:scale-110')
