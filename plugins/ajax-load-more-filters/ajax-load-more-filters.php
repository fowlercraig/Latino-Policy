...
define('ALM_FILTERS_VERSION', '1.11.0');
define('ALM_FILTERS_RELEASE', 'January 3, 2021');
   	...
   	public static function alm_filters_list_terms($obj, $queryString, $id){
			...
			if ( isset( $terms ) && $terms ) {
				...
				switch ($obj['field_type']) {
					...
					case 'select_multiple' :
						...
						ob_start();
						self::alm_build_terms_select($obj, $matchArray, $selected, $items);
		...
		public static function alm_build_terms_list($obj, $matchArray, $terms, $init){
			...
			foreach($terms as $item) {
				...
				// Build `<li/>`.
				echo '<li class="alm-filter--'. $obj['field_type'] . '">';
